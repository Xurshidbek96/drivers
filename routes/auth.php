...
Route::middleware('guest')->group(function () {
    ...
    // Driver auth routes start

    Route::prefix('driver/')->name('driver.')->group(function(){

        Route::get('register', [DriverController::class, 'showRegisterPage'])
                ->name('showRegisterPage');

        Route::post('register', [DriverController::class, 'store'])
        ->name('register');

        Route::get('login', [DriverController::class, 'showLoginPage'])
                    ->name('showLoginPage');
